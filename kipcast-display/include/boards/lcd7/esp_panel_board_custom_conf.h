 ...
 */
    ...
    #define ESP_PANEL_BOARD_LCD_RGB_CLK_HZ          (12 * 1000 * 1000)  // 16 MHz from Waveshare drifted under WiFi load
...
#define ESP_PANEL_BOARD_EXPANDER_POST_BEGIN_FUNCTION(p) \
    {  \
        ...
        /* Low routes GPIO19/20 to native USB rather than CAN, keeping the USB port alive */ \
